...
class Printer {
    ...
    private static final String STATUS_CODE_TAG = "LiveDataStatus Code: ";
    ...
    static void printJsonRequest(LoggingInterceptor.Builder builder, Request request) {
        ...
        if (builder.getLogger() == null)
            I.Companion.log(builder.getType(), tag, REQUEST_UP_LINE);
        ...
        if (builder.getLogger() == null)
            I.Companion.log(builder.getType(), tag, END_LINE);
    }
    ...
    static void printJsonResponse(LoggingInterceptor.Builder builder, long chainMs, boolean isSuccessful,
        ...
        if (builder.getLogger() == null)
            I.Companion.log(builder.getType(), tag, RESPONSE_UP_LINE);
